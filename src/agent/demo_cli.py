...
def print_trace(trace):
    ...
    print(f"\n({trace['elapsed_seconds']}s, {len(trace['tool_calls'])} tool call(s): {trace['tool_calls']})")
...
def main():
    ...
    parser.add_argument("--question", help="freeform question (only used with --provider anthropic)")
